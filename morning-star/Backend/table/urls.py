...
from .views import (
    ...
    TableImageUploadView, SessionPlayersView, MasterCharacterView,
)
...
urlpatterns = [
    ...
    path('table/<str:code>/players/',                               SessionPlayersView.as_view(),   name='session_players'),
    path('table/<str:code>/character/<int:character_id>/',          MasterCharacterView.as_view(),  name='master_character_view'),
